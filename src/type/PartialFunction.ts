...
type PartialFunction<TResult, TParameters extends unknown[], TApplied extends unknown[]> =
    ...
    TApplied extends [ unknown, unknown, unknown, unknown, unknown ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Shift<Tuple.Shift<Tuple.Shift<Tuple.Shift<TParameters>>>>>>
        :
    ...
    TApplied extends [ undefined, undefined, undefined, unknown ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Reorder<TParameters, [ 3, 0, 1, 2, 4 ]>>>
        :
    TApplied extends [ undefined, undefined, unknown, undefined ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Reorder<TParameters, [ 2, 0, 1, 3, 4 ]>>>
        :
    TApplied extends [ undefined, unknown, undefined, undefined ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Reorder<TParameters, [ 1, 0, 2, 3, 4 ]>>>
        :
    TApplied extends [ unknown, undefined, undefined, undefined ]
        ? VariadicFunction<TResult, Tuple.Shift<TParameters>>
        :
    TApplied extends [ undefined, undefined, unknown, unknown ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Shift<Tuple.Reorder<TParameters, [ 2, 3, 0, 1, 4 ]>>>>
        :
    TApplied extends [ undefined, unknown, undefined, unknown ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Shift<Tuple.Reorder<TParameters, [ 1, 3, 0, 2, 4 ]>>>>
        :
    TApplied extends [ unknown, undefined, undefined, unknown ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Shift<Tuple.Reorder<TParameters, [ 0, 3, 1, 2, 4 ]>>>>
        :
    TApplied extends [ undefined, unknown, unknown, undefined ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Shift<Tuple.Reorder<TParameters, [ 1, 2, 0, 3, 4 ]>>>>
        :
    TApplied extends [ unknown, undefined, unknown, undefined ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Shift<Tuple.Reorder<TParameters, [ 0, 2, 1, 3, 4 ]>>>>
        :
    TApplied extends [ unknown, unknown, undefined, undefined ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Shift<TParameters>>>
        :
    TApplied extends [ undefined, unknown, unknown, unknown ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Shift<Tuple.Shift<Tuple.Reorder<TParameters, [ 1, 2, 3, 0, 4 ]>>>>>
        :
    TApplied extends [ unknown, undefined, unknown, unknown ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Shift<Tuple.Shift<Tuple.Reorder<TParameters, [ 0, 2, 3, 1, 4 ]>>>>>
        :
    TApplied extends [ unknown, unknown, undefined, unknown ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Shift<Tuple.Shift<Tuple.Reorder<TParameters, [ 0, 1, 3, 2, 4 ]>>>>>
        :
    TApplied extends [ unknown, unknown, unknown, undefined ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Shift<Tuple.Shift<TParameters>>>>
        :
    TApplied extends [ unknown, unknown, unknown, unknown ]
        ? VariadicFunction<TResult, Tuple.Shift<Tuple.Shift<Tuple.Shift<Tuple.Shift<TParameters>>>>>
        :
